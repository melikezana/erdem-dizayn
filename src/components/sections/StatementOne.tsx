...
export const StatementOne: React.FC = () => {
  return (
    <section
      id="about"
      className="relative w-full border-t border-[#102B49]/10 px-5 py-20 sm:px-10 sm:py-24 lg:px-20"
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:items-end">
          ...
          <p className="max-w-xl text-base leading-8 text-[#102B49]/76 sm:text-lg lg:col-span-5">
        ...
        <div className="mt-14 grid grid-cols-1 border-y border-[#102B49]/10 sm:grid-cols-2 lg:grid-cols-4">
          {TRUST_ITEMS.map((item) => (
            <div
              key={item}
              className="flex min-h-20 items-center gap-3 border-b border-[#102B49]/10 py-5 sm:px-5 lg:border-b-0 lg:border-r lg:last:border-r-0"
            >
