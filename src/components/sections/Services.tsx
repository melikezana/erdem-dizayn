    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <ScrollReveal className="mb-14 grid grid-cols-1 gap-8 border-b border-[#102B49]/10 pb-8 lg:grid-cols-12 lg:items-end">
          ...
          <p className="ed-body-copy max-w-xl text-base leading-8 text-[#102B49]/72 lg:col-span-5">
        ...
        <div className="divide-y divide-[#102B49]/10 border-b border-[#102B49]/10">
          {SERVICES_DATA.map((service, index) => (
            <ScrollReveal
              ...
              as="article"
              delay={index * 0.04}
              className="ed-card-lift grid grid-cols-1 gap-6 py-9 transition-colors hover:bg-[#FBFAF7]/70 lg:grid-cols-12 lg:gap-10"
            >
              <div className="flex items-start gap-5 lg:col-span-4">
                ...
                <h3 className="ed-card-title font-serif text-2xl font-bold leading-tight text-[#102B49] sm:text-3xl">
                  {service.title}
                </h3>
              </div>

              <div className="lg:col-span-4">
                <p className="ed-body-copy text-base leading-8 text-[#102B49]/78 sm:text-lg">
                  {service.description}
                </p>
              </div>
        ...
        <div className="mt-10 flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:justify-between">
          <p className="ed-body-copy-sm max-w-xl text-sm leading-6 text-[#102B49]/65">
