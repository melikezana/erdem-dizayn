...
export const ContactCTA: React.FC<ContactCTAProps> = ({ onOpenAppointment }) => {
  return (
    <section
      id="contact"
      className="ed-section-shell relative w-full overflow-hidden bg-[#102B49] px-5 py-24 text-[#F6F2EA] sm:px-10 lg:px-20"
    >
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 gap-12 lg:grid-cols-12 lg:items-end">
        <ScrollReveal className="lg:col-span-8">
          <div className="ed-eyebrow mb-6 inline-flex items-center gap-3 rounded-full border border-white/20 px-4 py-1.5 text-[11px] font-semibold uppercase tracking-[0.24em] text-[#B8733E]">
            <span>İLETİŞİM</span>
          </div>

          <h2 className="ed-section-title-sm mb-7 font-serif text-3xl font-bold leading-tight text-white sm:text-5xl lg:text-6xl">
            Bir fikriniz mi var?
            <br />
          ...
          <p className="ed-body-copy max-w-2xl text-base leading-8 text-white/78 sm:text-lg">
          ...
          <div className="mt-10 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            <button
              ...
              className="ed-interactive inline-flex min-h-12 cursor-pointer items-center justify-center gap-2 rounded-full bg-[#9A5C2F] px-7 text-sm font-semibold uppercase tracking-[0.12em] text-white transition-colors hover:bg-[#B8733E] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#B8733E]"
            >
            ...
            <a
              ...
              className="ed-interactive inline-flex min-h-12 items-center justify-center gap-2 rounded-full border border-white/20 px-7 text-sm font-semibold uppercase tracking-[0.12em] text-white transition-colors hover:border-[#B8733E] hover:text-[#B8733E] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#B8733E]"
            >
        ...
        <ScrollReveal className="lg:col-span-4" delay={0.08}>
          <div className="border-y border-white/10 py-7">
            ...
            <p className="ed-body-copy-sm text-sm leading-7 text-white/62">
